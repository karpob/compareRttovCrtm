...
if __name__ == "__main__":
    ...
    idxOz = np.array([1012,1024,1088,1111,1120])-1
    ...
    for i,n in enumerate(profileNames): 
        ...
        for s in sensitivities:
            ...
            plotLines ( sValCrtm[idxOz], profilesCRTM.P[i,:], "Sensitivity [K]", "Pressure [hPa]",(idxOz+1).tolist(), 'Jacobians', key+'{}k_crtm_sub_lines.png'.format( s.lower() ), ylim =[100,1000],figureResolution = 300 )
